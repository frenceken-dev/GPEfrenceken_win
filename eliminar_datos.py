...
# Limpiar el frame de cualquier contenido
    ...
    crear_boton(frame_botones, 
            ...
            comando=lambda: eliminar_proveedor(root, volver_menu, imagen_tk, imagen_panel_tk),

            ).pack(pady=15)
    
    # Eliminar Materiales
    crear_boton(frame_botones, 
            texto="Eliminar Material", 
            ancho=30,
            alto=30,
            color_fondo="#eb4747",                
            color_texto="white",
            ...
            hover_color="#2ECC71",
            #activeforeground="black",
            comando=lambda: eliminar_material(root, volver_menu, imagen_tk, imagen_panel_tk), 
    ...
    crear_boton(frame_botones, 
            ...
            hover_color="#2ECC71",
            #activeforeground="black",
            comando=lambda: eliminar_producto(root, volver_menu, imagen_tk, imagen_panel_tk), 
    ...
    crear_boton(frame_botones, 
            ...
            hover_color="#2ECC71",
            #activeforeground="black",
            comando=lambda: eliminar_usuario(root, volver_menu, imagen_tk, imagen_panel_tk), 
...
def eliminar_proveedor(root, volver_menu, imagen_tk, imagen_panel_tk):
    ...
    crear_boton(eliminar_proveedor_frame, 
                texto="Eliminar",
                ancho=30,
                alto=30,
                color_fondo="#eb4747",                
                ...
                hover_color="#2ECC71",
                #activeforeground="black",
                comando=confirmar_eliminar_proveedor).pack(pady=5)
    ...
    crear_boton(frame_botones,
                ...
                #activeforeground="black",
                #bg=0,
                comando=lambda: eliminar_datos(root, volver_menu, imagen_tk, imagen_panel_tk)).pack(side=tk.LEFT, padx=30, pady=40)
...
def eliminar_material(root, volver_menu, imagen_tk, imagen_panel_tk):
    ...
    crear_boton(eliminar_material_frame, 
                ...
                hover_color="#2ECC71",
                #activeforeground="black",
                comando=confirmar_eliminar_material).pack(pady=5)
...
def eliminar_producto(root, volver_menu, imagen_tk, imagen_panel_tk):
    ...
    crear_boton(eliminar_producto_frame, 
                ...
                hover_color="#2ECC71",
                #activeforeground="black",
                comando=confirmar_eliminar_producto).pack(pady=5)
...
def eliminar_usuario(root, volver_menu, imagen_tk, imagen_panel_tk):
    ...
    crear_boton(eliminar_usuario_frame, 
                ...
                hover_color="#2ECC71",
                #activeforeground="black",
                comando=confirmar_eliminar_usuario).pack(pady=5)
