...
def abrir_actualizar_costo_por_unidad(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk):
    ...
    if not productos:
        ...
        back_button = crear_boton(frame_menu, 
                ...
                #bg=0, 
                comando=lambda : abrir_modulo_costos_ganancias(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk))
    ...
    clear_button = crear_boton(
        frame_menu,
        texto="Limpiar Pantalla",
        ancho=30,
        alto=30,
        color_fondo="#4B82F0",                
        color_texto="white",
...
def abrir_actualizar_costo_por_lote(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk):
    ...
    crear_lote_button = crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: abrir_formulario_crear_lote(center_frame)
    )
    ...
    update_button = crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: actualizar_costo_de_lote(
...
def abrir_formulario_crear_lote(parent_frame):
    ...
    guardar_button = crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: guardar_nuevo_lote(
...
def abrir_actualizar_historial(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk):
    ...
    calculate_button = crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda:calcular_y_guardar_ganancias(cal.get_date()),
        #width=20
    )
...
def mostrar_historial_ganancias(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk):
    ...
    show_button = crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: mostrar_historial_ganancias_opcion(
            opcion_var.get(),
    ...
    def mostrar_historial_ganancias_opcion(opcion, producto_str=None, mes_str=None):
        ...
        # Botón para imprimir el historial
        boton_imprimir_ganancias = crear_boton(
            resultado_frame,
            ...
            hover_color="#2ECC71",
            #activeforeground="black",
            comando=lambda: imprimir_historial_ganancias(historial, opcion, mes_str)
        )
...
def abrir_modulo_costos_ganancias(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk):
    ...
    unidad_button = crear_boton(
        frame_botones_cg,
        texto="Actualizar Costo de Unidad",
        ancho=30,
        alto=30,
        color_fondo="#3498DB",                
        color_texto="white",
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: abrir_actualizar_costo_por_unidad(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk),
        
    )
    unidad_button.pack(side=tk.TOP, padx=20, pady=10)

    # Botón para actualizar costo por lote
    lote_button = crear_boton(
        frame_botones_cg,
        texto="Actualizar Costo de Lote",
        ancho=30,
        alto=30,
        color_fondo="#138A11",                
        color_texto="white",
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: abrir_actualizar_costo_por_lote(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk),
    ...
    crear_boton(
        frame_botones_cg,
        texto="Act. Historial de Ganancias",
        ancho=30,
        alto=30,
        color_fondo="#153FB3",                
        color_texto="white",
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: abrir_actualizar_historial(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk),
    ...
    crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: mostrar_historial_costos(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk),
    ...
    crear_boton(
        ...
        hover_color="#2ECC71",
        #activeforeground="black",
        comando=lambda: mostrar_historial_ganancias(root, mostrar_menu_principal, imagen_panel_tk, rol, imagen_tk),
        #width=25,
    ).pack(pady=15)
